...
use LaraWp\Includes\Support\Arr;

class Request {
    use FileHandler, Cleaner, Validator;
    ...
    public function validate(array $rules) {
        ...
        foreach ($rules as $field => $fieldRules) {
            ...
            foreach ($fieldRules as $rule) {
                ...
                // Check for rules with parameters, e.g., 'max:255'
                ...
                // Run validation
                $error = $this->$validationMethod($field, $value, $ruleParam);
                if ($error) {
                    $errors[$field][] = $error;
                }
            }
